...
import worldMapImage from 'C:/Users/lenovo/Desktop/React_TS 2/React_TS/my-app/src/images/Screenshot 2023-06-27 232746.png';
      ...
      <div className="flex">
        <div className="w-1/2">
          <div className="world-map">
            <img src={worldMapImage} alt="World Map" style={{ width: '80%' }} />
          </div>
        </div>
